        ...
        <div id="header_wrapper" class="main_wrapper">
            ...
            <nav>
                ...
                <ul id="navlist">
                    ...
                    <li><a href="./?p=timeline"
                            title="Gardener Timeline shows your tracking of your plants">Timeline</a>
                    </li>
                    <li><a href="./?p=community"
                            title="Gardener Community shows what other people is doing">Community</a>
                    </li>
            ...
            <div id="account_login">
                ...
                <?php if ($title == 'Register' || $title == 'Home' || $title == 'Mine' || $title == 'Timeline' || $title == 'Newsletter' || $title == 'Community') : ?>
                ...
                <span><a href="#"
                        class="plain_a"><?= ucwords(str_replace('_', ' ', e($results['first_name']))) ?></a></span>
                <?php endif; ?>
            </div>
